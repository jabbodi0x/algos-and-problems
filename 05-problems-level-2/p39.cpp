...
void copyPrimeNumbersFromArrayToAnotherArray(int* originalArray, int* copyArray, int arraySize,int &copyArraySize)
{
	for (int i = 0; i < arraySize; i++)
	{
...
int main()
{
	...
	copyPrimeNumbersFromArrayToAnotherArray(array, copyArray, 100, copyArraySize);
