...
bool isIdentityMatrix(int matrix[3][3], short matrixRows, short matrixColumns)
{
	for (short i = 0; i < matrixRows; i++)
	{
		for (short j = 0; j < matrixColumns; j++)
...
int main()
{
	...
	int matrix2[3][3] = { {1,0,0},{0,2,0},{0,0,1} };

	printMatrix(matrix1, 3, 3, "Matrix 1 Elements:\n");
	printMatrix(matrix1, 3, 3, "Matrix 2 Elements:\n");

	if (isIdentityMatrix(matrix1, 3, 3))
		cout << "\nYES, Matrix is identity matrix\n\n";
	else
		cout << "\nNO, Matrix is NOT identity matrix\n\n";
